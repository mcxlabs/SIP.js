...
export class SessionDescriptionHandler {
  ...
  constructor(logger, mediaStreamFactory, sessionDescriptionHandlerConfiguration) {
    ...
    this._localMediaStream = new global.MediaStream();
    this._remoteMediaStream = new global.MediaStream();
    // this._temp = {iceServers: [{url: 'stun:stun.l.google.com:19302'}]};
  ...
  setRemoteTrack(track) {
    ...
    // this._peerConnection.remoteStream = remo
  ...
  initPeerConnectionEventHandlers() {
    ...
    peerConnection.onaddstream = (event) => {
      console.log("stream add event " + event);
      this._remoteMediaStream = event.stream;
    };
  }
}
